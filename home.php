...
$queryDisplay = $user->basicQuery('SELECT pseudo, post_content FROM users INNER JOIN post ON users.id = post.id_user order by id_post desc limit 20');


/* insers le tweet avec du front (bouton like,rt etc) */
while ($speed = $queryDisplay->fetch()) {
    $result .= '
    <div class="main-container">
        <div class="container_bis">
            <div class="tweet-card">
                <img class="avatar" src="https://pbs.twimg.com/profile_images/1122210437695725574/wPB3Jrkt_400x400.png">

                <div class="content">
                    <div class="author">
                        <a href="profil.php" class="twitter-name" target="_blank"> ' . $speed['pseudo'] . '</a>
                        <span class="twitter-handle"><a href="#"></a>@' . $speed['pseudo'] . '</span>
                        <a href="#" class="twitter-time">Il y a --min</a>
                    </div>

                    <p class="tweet">' . $speed['post_content'] . '</p>
                    ...
                    <div id="lol">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body" id="resizable">
                                <form accept-charset="UTF-8" action="postTweet.php" method="POST" id="postTweet">
                                    <div id="style_textearea">
                                        <textarea id="fullfilled" class="form-control counted" name="tweet" placeholder="Éxprimez-vous en quelques mots..." rows="5" style="margin-bottom:10px;" required></textarea>
                                    </div>
