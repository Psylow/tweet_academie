      ...
      <div class="inbox_msg">
        ...
        <div class="mesgs">
          <div class="msg_history">
            <!-- Ici c'est là ou se stockent les messages -->
            <div class="message">
              <?php include('classes/handler.php') ?>
            </div>
          </div>
          <div class="input_msg_write">
            <form action="classes/handler.php?task=write" method="post">
              <input type="text" id="content" class="write_msg" name="content" placeholder="Écrivez votre message">
